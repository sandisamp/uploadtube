			...
			<div class="top-navigation">
				...
				<div class="drop-navigation drop-navigation">
				  <ul class="nav nav-sidebar">
					...
					<li class="active"><a href="history.php" class="sub-icon"><span class="glyphicon glyphicon-home glyphicon-hourglass" aria-hidden="true"></span>History</a></li>
			...
			<div class="show-top-grids">
				<div class="main-grids news-main-grids">
					<div class="recommended-info">
						<h3>History</h3>
                        <p><center><em><strong><h2>Nothing to see here...</h2></strong></em></center></p>
					</div>
				</div>
			</div>
			<!-- footer -->
