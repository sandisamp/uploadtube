				...
				<div class="upload-grids">
					<div class="upload-right">
						<div class="upload-file">
							<div class="services-icon"><form action="up_file.php" method="POST" enctype="multipart/form-data">
							...
							<div id="title"><p style="margin-left:40%;">Video Title:</p><input style="margin-left:35%;" type="text" required name="title"><br></div>
				</div><center><input type="submit" class="signin" id="video_up_but" name="submit" value="submit"/></center></form>
