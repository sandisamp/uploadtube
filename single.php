				...
				<div class="drop-navigation drop-navigation">
				  ...
				  <!-- script-for-menu -->
					...
					<div class="side-bottom">
						...
						<!-- <div class="copyright">
							<p>Copyright © Pranshu Choubey</a></p>
						</div> -->
					</div>
				</div>
        </div>
				...
				<div class="col-sm-8 single-left">
					<div class="song">
						...
						<div class="video-grid">
							<video width="560" height="315" controls><source 
							src=<?php echo '"'.$row['url'].'"' ?>></video>
						</div>
					</div>
					<div class="song-grid-right">
						<div class="share">
							<h5>Share this</h5>
							<ul>
								<li><a href="http://localhost/uploadtube/fb_upload.php?id=<?php echo $row['id']; ?>" class="icon fb-icon">Facebook</a></li>
								<!-- <li><a href="#" class="icon dribbble-icon">Dribbble</a></li> -->
								<li><a href="#" class="icon twitter-icon">Twitter</a></li>
								<li><a href="#" class="icon googleplus-icon">Goolge+</a></li>
								<!-- <li><a href="#" class="icon whatsapp-icon">Whatsapp</a></li> -->
								<li><a href="http://localhost/uploadtube/delete.php?id=<?php echo $row['id']; ?>" class="icon like">Delete this video</a></li>
								<li><a href="#" class="icon comment-icon">Comments</a></li>
								<li class="view">200,000,000 Views</li>
							</ul>
						</div>
					</div>
					<div class="clearfix"> </div>
					<div class="published">
						<script src="jquery.min.js"></script>
							...
							<div class="load_more">	
								<ul id="myList">
									<li>
										<h4>Published on <?php echo $row['up_time']; ?></h4>
										<p></p>
									</li>
									<li>
